...
export default function NeedleFreePage() {
  ...
  // Update meta tags
  React.useEffect(() => {
    document.title = t.needlefree.meta.title;
    document.querySelector('meta[name="description"]')?.setAttribute('content', t.needlefree.meta.description);
    document.querySelector('meta[name="keywords"]')?.setAttribute('content', t.needlefree.meta.keywords);
  }, [t.needlefree.meta]);
