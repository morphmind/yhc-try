            ...
            <div className="relative text-center space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full sm:w-auto h-14 px-10 text-base gap-2 rounded-full bg-white/80 dark:bg-black/50 backdrop-blur-md border border-black/[0.08] dark:border-white/[0.08] text-primary dark:text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-black/5 dark:hover:bg-black/70 hover:scale-[1.02] active:scale-[0.98]"
