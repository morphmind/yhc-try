...
export function HeroSection({ onAnalysisClick, onWhatsAppClick }: HeroSectionProps) {
  ...
  const stats = [
    {
      value: t.womenHairTransplant.hero.stats.experience.value,
      label: t.womenHairTransplant.hero.stats.experience.label,
      icon: Clock,
      gradient: 'from-emerald-500/20 to-green-500/20',
      iconColor: 'text-emerald-500'
    },
    {
      value: t.womenHairTransplant.hero.stats.operations.value,
      label: t.womenHairTransplant.hero.stats.operations.label,
      icon: CheckCircle,
      gradient: 'from-blue-500/20 to-indigo-500/20',
      iconColor: 'text-blue-500'
    },
    {
      value: t.womenHairTransplant.hero.stats.satisfaction.value,
      label: t.womenHairTransplant.hero.stats.satisfaction.label,
      icon: Star,
      gradient: 'from-purple-500/20 to-pink-500/20',
      iconColor: 'text-purple-500'
    },
    {
      value: t.womenHairTransplant.hero.stats.guarantee.value,
      label: t.womenHairTransplant.hero.stats.guarantee.label,
      icon: Shield,
  ...
  return (
    <div className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden pt-[72px] md:pt-[88px] lg:pt-0 pb-8">
      {/* Background Pattern */}
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="relative space-y-6 sm:space-y-8 text-center lg:text-left">
            ...
            <div className="hidden lg:inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-white/90 dark:bg-white/10 backdrop-blur-md border border-black/[0.08] dark:border-white/[0.08] shadow-[0_2px_8px_rgba(0,0,0,0.04)] dark:shadow-[0_2px_8px_rgba(255,255,255,0.04)] mb-6 sm:mb-8 relative z-[15] group transition-all duration-300 hover:scale-[1.02] mx-auto lg:mx-0">
              ...
              <span className="text-sm font-medium text-foreground/80 dark:text-white/80">{t.womenHairTransplant.hero.badge}</span>
            </div>

            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold !leading-[1.15] tracking-tight">
              <span className="bg-gradient-to-r from-blue-400 via-cyan-400 to-indigo-400 bg-clip-text text-transparent">
                {t.womenHairTransplant.hero.title.highlight}
              </span>
              <span className="block mt-2 text-foreground dark:text-white text-[0.85em]">
                {t.womenHairTransplant.hero.title.main}
              </span>
            </h1>
            ...
            <p className="text-sm sm:text-base md:text-lg text-foreground/60 dark:text-white/60 leading-relaxed max-w-xl mx-auto lg:mx-0">
              {t.womenHairTransplant.hero.description}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              ...
              >
                ...
                {t.womenHairTransplant.cta.buttons.analysis}
              </Button>
              <Button 
                size="lg"
                variant="outline"
              ...
              >
                ...
                {t.womenHairTransplant.cta.buttons.whatsapp}
              </Button>
            </div>
          </div>
          ...
          <div className="relative mt-8 sm:mt-10 lg:mt-0 z-[1]">
            <div className="relative">
              ...
              {/* Image Container */}
              <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-white/10 shadow-[0_4px_16px_rgba(0,0,0,0.1)] dark:shadow-[0_4px_16px_rgba(255,255,255,0.1)]">
                <img
                  src="https://glokalizm.com/yakisikli/img/women-hair-transplant/hero-mobile.jpg"
                  alt="Women Hair Transplant"
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className={cn(
                ...
                "h-[90px] sm:h-[100px]", // Slightly taller on mobile for better readability
