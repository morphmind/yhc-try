...
export default function FUEHairTransplantPage() {
  ...
  // Update meta tags
  React.useEffect(() => {
    document.title = t.fuetechnique.meta.title;
    document.querySelector('meta[name="description"]')?.setAttribute('content', t.fuetechnique.meta.description);
    document.querySelector('meta[name="keywords"]')?.setAttribute('content', t.fuetechnique.meta.keywords);
  }, [t.fuetechnique.meta]);
