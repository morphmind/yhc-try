...
export function HeroSection({ onAnalysisClick, onWhatsAppClick }: HeroSectionProps) {
  ...
  const stats = [
    {
      value: t.fuetechnique.hero.stats.experience.value,
      label: t.fuetechnique.hero.stats.experience.label,
      icon: CheckCircle,
      gradient: 'from-emerald-500/20 to-green-500/20',
      iconColor: 'text-emerald-500'
    },
    {
      value: t.fuetechnique.hero.stats.precision.value,
      label: t.fuetechnique.hero.stats.precision.label,
      icon: Ruler,
      gradient: 'from-blue-500/20 to-indigo-500/20',
      iconColor: 'text-blue-500'
    },
    {
      value: t.fuetechnique.hero.stats.success.value,
      label: t.fuetechnique.hero.stats.success.label,
      icon: Star,
      gradient: 'from-purple-500/20 to-pink-500/20',
      iconColor: 'text-purple-500'
    },
    {
      value: t.fuetechnique.hero.stats.recovery.value,
      label: t.fuetechnique.hero.stats.recovery.label,
      icon: Clock,
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="relative space-y-6 sm:space-y-8 text-center lg:text-left">
            ...
            <p className="text-sm sm:text-base md:text-lg text-foreground/60 dark:text-white/60 leading-relaxed max-w-xl mx-auto lg:mx-0">
              {t.fuetechnique.hero.description}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              ...
              >
                ...
                {t.fuetechnique.cta.buttons.analysis}
              </Button>
              <Button 
                size="lg"
                variant="outline"
              ...
              >
                ...
                {t.fuetechnique.cta.buttons.whatsapp}
              </Button>
            </div>
          </div>
          ...
          <div className="relative mt-8 sm:mt-10 lg:mt-0 z-[1]">
            <div className="relative">
              ...
              {/* Image Container */}
              <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-black/[0.08] dark:border-white/[0.08] shadow-[0_4px_16px_rgba(0,0,0,0.1)] dark:shadow-[0_4px_16px_rgba(255,255,255,0.1)]">
                <img
                  src="https://glokalizm.com/yakisikli/img/techniq/fue-hair-transplant.jpg"
