...
export function HeroSection({ onAnalysisClick, onWhatsAppClick }: HeroSectionProps) {
  ...
  const stats = [
    {
      value: t.dhitechnique.hero.stats.precision.value,
      label: t.dhitechnique.hero.stats.precision.label,
      icon: Ruler,
      gradient: 'from-emerald-500/20 to-green-500/20',
      iconColor: 'text-emerald-500'
    },
    {
      value: t.dhitechnique.hero.stats.density.value,
      label: t.dhitechnique.hero.stats.density.label,
      icon: CheckCircle,
      gradient: 'from-blue-500/20 to-indigo-500/20',
      iconColor: 'text-blue-500'
    },
    {
      value: t.dhitechnique.hero.stats.success.value,
      label: t.dhitechnique.hero.stats.success.label,
      icon: Star,
      gradient: 'from-purple-500/20 to-pink-500/20',
      iconColor: 'text-purple-500'
    },
    {
      value: t.dhitechnique.hero.stats.recovery.value,
      label: t.dhitechnique.hero.stats.recovery.label,
      icon: Clock,
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="relative space-y-6 sm:space-y-8 text-center lg:text-left">
            ...
            <p className="text-sm sm:text-base md:text-lg text-foreground/60 dark:text-white/60 leading-relaxed max-w-xl mx-auto lg:mx-0">
              {t.dhitechnique.hero.description}
            </p>
          ...
          <div className="relative mt-8 sm:mt-10 lg:mt-0 z-[1]">
            <div className="relative">
              ...
              <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-white/10 shadow-[0_4px_16px_rgba(0,0,0,0.1)] dark:shadow-[0_4px_16px_rgba(255,255,255,0.1)]">
                <img
                  src="https://glokalizm.com/yakisikli/img/techniq/dhi-hair-transplant.jpg"
